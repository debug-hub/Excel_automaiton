...
sheet = excel['V2V TOP SHEET 01-04-21_100561']
sheet_1 = excel_1['V2V TOP SHEET 01-04-21_100561']
...
def master(ws_m,wb,path2,part_code, vendor, plant,date,INM,RM,gross_weight,x):
    ...
    wb.save(r"D:/SequelString/[pcr][HCL]/Bajajsons_master_VTV.xlsx")
...
def oe(part_code,vendor,plant,date):
    ...
    wb2.save(r"D:/SequelString/[pcr][HCL]/Bajajsons_hierarchy-VTV.xlsx")
...
for i in range (5,18):
    ...
    vendor = sheet['B'+str(i)].value
    plant = sheet['D'+str(i)].value
    date = '01.04.2021'
    rpl = sheet['M'+str(i)].value
    rpv = sheet_1['M'+str(i)].value

##    print('directsup',directsup)
    oe(part_code,vendor,plant,date)

    print('INDIRECT_VENDOR:',plant)
                    ...
                    if sheet2_2['U'+str(j)].value != None:
                        ...
                        if sheet2_2['Z'+str(j)].value == None:
                            ...
                            if 'Nut Spl 6 mm' == BOP:
                                ...
                                BOP_COST = sheet2['AA'+str(j)].value
